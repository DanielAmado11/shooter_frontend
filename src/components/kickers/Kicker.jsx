...
Command: npx gltfjsx@6.2.16 ../models/kicker/kicker.gltf 
*/
...
export function Kicker(props) {
  ...
  const [lastPosition, setLastPosition] = useState(
    new THREE.Vector3(
      kicker_positions[position].idle.position[0],
      kicker_positions[position].idle.position[1],
      kicker_positions[position].idle.position[2]
    )
  );

  const handleKick = () => {
    const action = actions[names[0]].setLoop(THREE.LoopOnce, 1);
    action.reset();
    action.play();
...
useGLTF.preload("./models/kicker/kicker.gltf");
